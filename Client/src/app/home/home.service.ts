...
export class HomeService {
  ...
  getFollowPosts(userId) {
    return new Promise<string>(resolve => {
      return this.http.get(this.ROOT_URL + '/home/GetHomePosts?userId=' + userId).subscribe((data) => {
        resolve(JSON.stringify({ "returnCode": "true", "responseText": "succesfully retrieved all posts.", "data": data }));
      }, (err) => {
          console.log(err);
